void Paleta(int palette, int iter, int *r, int *g, int *b)
{
    int (*p)[256][3];                  // ukazatel na vybranou paletu
    static int blues[256][3]={
